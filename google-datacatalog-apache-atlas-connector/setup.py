...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            'google-datacatalog-apache-atlas-connector = google.datacatalog_connectors.apache_atlas:main',
        ],
    },
    ...
    tests_require=('numpy==1.19.4',
                   'pytest-cov==2.10.1', 'google-datacatalog-connectors-commons-test>=0.6.0'),
    classifiers=(
        release_status,
