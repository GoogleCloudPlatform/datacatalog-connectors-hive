...
public class DropDatabaseEventRequest {

    public DropDatabaseEventRequest(DatabaseMetadata database, String hostName) {
        this.database = database;
        this.hostName = hostName;
    }

    private DatabaseMetadata database;
    private MetadataEvent event = MetadataEvent.DROP_DATABASE;
